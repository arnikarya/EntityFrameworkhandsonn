...
namespace ConsoleApp1
{
    public class program
    {
        public static void Main()
        {
            ...
            obj.Insert(new Employee { Name = "Aryan", Address = "Gurgaon" });
            obj.Insert(new Employee { Name = "Nikhil", Address = "Delhi" });
            PrintAllEmployees();
